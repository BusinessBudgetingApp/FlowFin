          ...
          <div className="pt-4">
            <form
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  <label className="block text-[14px] text-[#212121] mb-3 font-medium">Kategori Pendapatan <span className="text-red-500">*</span></label>
                  <input
                    name="category"
                    id="category"
                    type="text"
                ...
                <div className="flex-1">
                  <label className="block text-[14px] text-[#212121] mb-3  font-medium">Jumlah Pendapatan <span className="text-red-500">*</span></label>
                  <input
                    type="number"
                    name="amount"
                    id="amount"
